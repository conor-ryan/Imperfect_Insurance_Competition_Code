...
ggplot(merger_welfare[policy=="Base"]) + aes(x=dHHI,y=chg_Tot_Welfare) + 
  geom_point()

ggplot(merger_welfare[policy=="RA"]) + aes(x=dHHI,y=chg_Tot_Welfare) + 
  geom_point()

ggplot(merger_welfare[policy=="Man"]) + aes(x=dHHI,y=chg_Tot_Welfare) + 
  geom_point()

ggplot(merger_welfare[policy=="RAMan"]) + aes(x=dHHI,y=chg_Tot_Welfare) + 
  geom_point()
