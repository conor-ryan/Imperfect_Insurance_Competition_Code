...
baseData[,dCW_SP_SPcp:=CW_SP_cp-CW_SP_zp]
...
ggplot(baseData) + aes(x=CW_SP_cp,y=dCW_SPcp_Base) + 
  geom_point()



Markets = baseData[,list(dCW_SPcp_Base = sum(dCW_SPcp_Base*PERWT)/sum(PERWT),
