function process_demand(rundate,spec,home_directory)
    ...
    println("The mean of costs in the bottom 10th percentile of elasticities is $mean_c, mean elasticity is $mean_elas")
    ...
    println("The mean of costs in the top 10th percentile of elasticities is $mean_c, mean elasticity is $mean_elas")
