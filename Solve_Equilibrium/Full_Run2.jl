...
@everywhere include("$codeDir/Solve_Equilibrium/predictionData.jl")
@everywhere include("$codeDir/Solve_Equilibrium/FirmFunctions.jl")
@everywhere include("$codeDir/Solve_Equilibrium/SolveModel.jl")
@everywhere include("$codeDir/Solve_Equilibrium/EvaluateModel.jl")
@everywhere include("$codeDir/Solve_Equilibrium/PriceUpdate.jl")
@everywhere include("$codeDir/Solve_Equilibrium/ConsumerWelfare.jl")
@everywhere include("$codeDir/Solve_Equilibrium/PlannerProblem.jl")
@everywhere include("$codeDir/Solve_Equilibrium/SolveMergers.jl")

MergersMain2(rundate,spec,home_directory)
