function unPackChars(app::ChoiceData,d::InsuranceLogit)
    ...
    return ind, r_ind, S_ij, wgt, urate, idxitr, X_t, X_0_t, Z, F_t,risk_age
end
...
function ll_obs_hessian!{T}(hess::Matrix{Float64},grad::Vector{Float64},
        ...
        ind, r_ind, S_ij, wgt, urate, idxitr, X_t, X_0_t, Z, F_t, r_age = unPackChars(app,d)
...
function calc_prodTerms!(n::Int64,dS1::Vector{Float64},
                        ...
                        dR::Vector{Float64},risk::Vector{Float64},
    ...
    for k in 1:K
        ...
        @inbounds @fastmath dR[k]+= tx*(risk[n]+risk_age[k])
